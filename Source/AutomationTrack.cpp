...
{
    auto pAutomationTrackElement = pPatchesElement->getChildByName("AutomationTrack");
    if (pAutomationTrackElement != nullptr) {
        loadFromXml(pAutomationTrackElement, "AutomationEvent", [this, pAutomationTarget](const juce::XmlElement* pChildElement, std::int64_t clickTimepoint) {
